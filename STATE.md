...
- **目前版本**：v18.260p5_AIAdvice（危機回測室 + Gemini AI 策略建議，Phase 5，5-PR Sprint 收官）
...
- **前版**：v18.260p4_StrategyGrid（危機回測室 + 4 策略 × 3 門檻 grid_search + heatmap，Phase 4）
- **前二版**：v18.260p3_MacroSignalLookback（危機回測室 + 總經訊號預測力驗證，Phase 3）
- **前三版**：v18.259_InvestCalcTWD（投資試算加 TWD 即時匯率換算）
