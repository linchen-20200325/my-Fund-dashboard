...
- VIX_WARNING_THRESHOLD（預設 18，grid [14, 16, 18, 20, 22], cap [14, 22]）
...
# 越界守門（鏡像 stock macro_helpers H∈[20,60] / S∈[1,6] 設計）
VIX_CRISIS_CAP = (25.0, 35.0)
VIX_WARNING_CAP = (14.0, 22.0)

# Grid（cap 內等距）
VIX_CRISIS_GRID: tuple = (25.0, 27.0, 30.0, 32.0, 35.0)
VIX_WARNING_GRID: tuple = (14.0, 16.0, 18.0, 20.0, 22.0)
