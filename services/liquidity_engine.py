...
from shared.signal_thresholds import (  # v19.74 W2 SSOT
    LIQUIDITY_XCCY_WEIGHT_RATIO,
    LIQUIDITY_CARRY_WEIGHT_RATIO,
...
DEFAULT_WEIGHTS: dict = {
    "XCCY_PROXY": LIQUIDITY_XCCY_WEIGHT_RATIO,
    "CARRY_UNWIND": LIQUIDITY_CARRY_WEIGHT_RATIO,
    "MOVE_VIX": LIQUIDITY_MOVE_WEIGHT_RATIO,
}
