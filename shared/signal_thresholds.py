...
# ════════════════════════════════════════════════════════════════════════
# 235 加碼引擎(基金版,v19.465)—— 郭俊宏「235 精準加碼」方法常數(DESIGN)
# §3.3:郭俊宏方法特有門檻,與總經 VIX zone(shared/macro_buckets 22/30)不同源、
...
# ════════════════════════════════════════════════════════════════════════
# 衛星停利自動化(v19.466)—— 郭俊宏 80/20:衛星部位獲利達門檻自動亮停利燈(DESIGN)
