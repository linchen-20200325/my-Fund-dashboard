...
def mk_fund_signal(fund_info: dict, phase: str, score: float) -> dict:
    ...
    SIG = {"buy":"background:#1a3328;color:{MATERIAL_GREEN};border:1px solid {MATERIAL_GREEN}","sell":f"background:#3a1a1a;color:{TRAFFIC_RED};border:1px solid {TRAFFIC_RED}","hold":"background:#1a3450;color:#58a6ff;border:1px solid #58a6ff","switch":"background:#3a2a10;color:#f0a500;border:1px solid #f0a500"}
